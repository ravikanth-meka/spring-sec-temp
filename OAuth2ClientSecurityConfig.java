 ...
 * </p>
 */
@Profile({"local","dev","dev2","prod","uat","cob"})
@Configuration
@EnableWebSecurity
@EnableOAuth2Client
...
public class OAuth2ClientSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public OAuth2ClientAuthenticationProcessingFilter
		...
		// We can use  UserInfo or TokenInfo
	...
	@Bean
	@Description("UserInfo resource server")
	public UserInfoTokenServices userInfoTokenServices() {
		UserInfoTokenServices userInfoTokenServices =
				new UserInfoTokenServices(userInfoUri, clientId);
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.exceptionHandling()
			...
			.and()
				...
				.addFilterBefore(
					oauth2ClientAuthenticationProcessingFilter(),
					FilterSecurityInterceptor.class).csrf().disable()
				.anonymous()
